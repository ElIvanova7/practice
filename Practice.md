...
*	Загрузка изображения: изображения продуктов должны загружаться быстро и эффективно, даже на экранах с низким разрешением.
...
SELECT Покупатели.Идентификатор, Покупатели.Имя, Покупатели.Фамилия,\ COUNT(Покупки.Идентификатор) AS 'Количество покупок'\
FROM Покупатели\
